  ...
  return (
    <div className="space-y-8 animate-fadeIn pb-12 w-full">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight leading-none">Add New Blog Post</h1>
          <p className="text-sm text-slate-500 mt-2 font-medium">Write and publish a new search engine optimized post.</p>
        </div>
      </div>
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
            ...
            >
              {saving ? (
                ...
                <>
                  <Save className="h-4.5 w-4.5" /> Save Post
                </>
              )}
            </button>
          </div>
