...
export const cities: Record<string, CityData> = {
    ...
    delhi: {
        ...
        description: "Simplify payroll, attendance, leave, employee management and statutory reporting with HR Niti — a cloud HRMS platform for businesses operating across Delhi, Gurgaon, Noida and other locations in India.",
        landmark: "India Gate",
        keywords: [
            "HRMS Software Delhi",
        ...
        metaDescription: "HRMS and payroll software for Delhi NCR businesses. Automate payroll, attendance, leave, employee self-service and HR reporting with HR Niti. Book a free demo.",
        hubs: ["Connaught Place", "Okhla Industrial Area", "Nehru Place", "Netaji Subhash Place", "South Extension", "Aerocity"],
        statutory: {
            ptName: "Automated Payroll & Statutory Compliance",
            lwfName: "Delhi Labour Welfare Fund (DLWF)",
            forms: ["Form 16", "Form 24Q", "EPF/ECR Reports", "ESIC Monthly Return", "Delhi LWF Return"],
            details: "Helps payroll teams manage statutory wage-rate updates and multi-state payroll rules for employees working across Delhi, Gurgaon, and Noida."
        },
        aeoSummary: "HR Niti is a cloud-based HRMS and payroll platform for businesses in Delhi NCR. It helps organizations manage payroll, attendance, employee self-service, recruitment, HR reporting and AI-assisted HR workflows across Delhi, Gurgaon, Noida and other locations in India.",
        faqs: [
            {
                question: "What is HRMS software?",
                answer: "HRMS software is a system used to manage employee information, attendance, leave, payroll, recruitment, HR workflows and workforce reporting from one platform."
            },
            {
                question: "What is payroll software?",
                answer: "Payroll software automates salary calculation, deductions, payslips, payroll reports and other recurring payroll processes."
            },
            {
                question: "What is the best HRMS software for a Delhi company?",
                answer: "The right HRMS depends on employee count, payroll complexity, attendance requirements, locations, integrations and HR workflows. Businesses should compare payroll automation, attendance, employee self-service, statutory reporting, security and support."
            },
            {
                question: "What is the cost of HRMS software in Delhi?",
                answer: "HRMS software in Delhi typically ranges based on team size, deployed modules, and implementation scope. Small businesses (1–50 employees) generally choose standard cloud subscriptions, mid-sized firms (51–250 employees) opt for multi-state payroll and attendance packages, and enterprises require custom integrations. Contact HR Niti for a transparent, customized quote."
            },
            {
                question: "Which payroll software is best for 100 employees in Delhi?",
                answer: "For a 100-employee company in Delhi NCR, the best payroll software automates salary processing, integrates biometric/GPS attendance, handles Delhi Labour Welfare Fund (DLWF) and multi-state compliance (for Gurgaon/Noida staff), and provides mobile Employee Self-Service (ESS) for instant payslip downloads."
            },
            {
                question: "Can HRMS software manage Delhi, Gurgaon and Noida employees?",
                answer: "Yes. HR Niti allows organizations to manage cross-NCR workforces under a single account, applying location-specific payroll rules, state statutory deductions (Delhi, Haryana, Uttar Pradesh), and regional holiday calendars automatically."
            },
            {
                question: "What payroll compliance does a Delhi company need to manage?",
                answer: "Delhi employers must manage Delhi Minimum Wages (revised semi-annually by the Delhi Labour Department), Delhi Labour Welfare Fund (DLWF) contributions, Employees' Provident Fund (EPF), Employees' State Insurance (ESIC), Tax Deducted at Source (TDS/Form 24Q), and annual Form 16 issuance."
            },
            {
                question: "How do I choose payroll software for a Delhi business?",
                answer: "When evaluating payroll software in Delhi, check for: (1) native support for Delhi statutory rules and multi-state NCR configurations, (2) biometric and mobile GPS attendance integration, (3) automated salary computation and one-click payslip distribution, (4) robust employee self-service (web and mobile), and (5) responsive local customer onboarding and support."
            },
            {
                question: "Can HR Niti manage employees in Delhi, Gurgaon and Noida?",
                answer: "Yes. HR Niti is designed to support organizations with employees across multiple locations and allows payroll and HR configurations to be managed according to workforce requirements."
            },
            {
                question: "Does HR Niti support payroll compliance?",
                answer: "HR Niti provides payroll workflows, configured statutory calculations and payroll/statutory reporting features for Indian businesses. Organizations should verify configurations against the latest applicable government requirements."
            },
            {
                question: "Does HR Niti support biometric attendance?",
                answer: "Yes. HR Niti supports attendance workflows that can integrate biometric attendance and other supported attendance methods."
            },
            {
                question: "Does HR Niti support GPS attendance?",
                answer: "HR Niti provides location-based attendance capabilities for organizations that need workforce attendance visibility outside traditional office environments."
            },
            {
                question: "Can employees access their payslips online?",
                answer: "Yes. Employees can access HR information and supported payroll documents through the employee self-service platform."
            },
            {
                question: "Does HR Niti have a mobile app?",
                answer: "HR Niti provides mobile employee self-service capabilities for supported HR workflows."
            },
            {
                question: "Can HR Niti manage payroll for multiple states?",
                answer: "Yes. HR Niti is designed for multi-location and multi-state workforce management with location-based payroll configurations."
            },
            {
                question: "Can HR Niti integrate with attendance machines?",
                answer: "HR Niti supports attendance integration workflows for compatible biometric and attendance systems."
            },
            {
                question: "Can HR Niti manage full and final settlement?",
                answer: "Yes. HR Niti includes workflows for employee exit and full-and-final settlement."
            },
            {
                question: "Can HR Niti manage recruitment?",
                answer: "Yes. HR Niti includes recruitment and applicant-tracking capabilities including candidate management and recruitment workflows."
            },
            {
                question: "Does HR Niti have AI features?",
                answer: "Yes. HR Niti includes AI-powered capabilities across areas such as HR assistance, recruitment, analytics and workforce automation."
            },
            {
                question: "Is HR Niti suitable for small businesses?",
                answer: "Yes. HR Niti offers HRMS capabilities for organizations of different sizes, including small and growing businesses."
            },
            {
                question: "Is HR Niti suitable for manufacturing companies?",
                answer: "Yes. Manufacturing organizations can use HR Niti for employee management, attendance, shifts, payroll and workforce reporting."
            },
            {
                question: "Is HR Niti suitable for pharma companies?",
                answer: "Yes. Pharma organizations can use HR Niti to manage employee records, attendance, payroll, recruitment and HR workflows."
            },
            {
                question: "How long does HRMS implementation take?",
                answer: "Implementation time depends on employee count, payroll complexity, integrations, data migration and configuration requirements. HR Niti follows a structured setup and testing process before go-live."
            },
            {
                question: "How can I get a demo of HR Niti?",
                answer: "You can request a personalized HRMS and payroll demonstration from the HR Niti team."
            },
            {
                question: "Does HR Niti support Delhi-specific payroll requirements?",
                answer: "HR Niti can be configured for relevant Delhi payroll workflows and statutory reporting requirements. Specific statutory configurations should be reviewed against the latest applicable government notifications."
            }
        ]
    },
    bangalore: {
