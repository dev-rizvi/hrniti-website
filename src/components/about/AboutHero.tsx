...
import { ArrowRight, Sparkles, ShieldCheck, CheckCircle2, Lock, Award, Building2 } from "lucide-react";
...
export default function AboutHero({
    ...
    const displayTitle = title || "Revolutionizing HR & Payroll for Digital India";
    const displaySubtitle = subtitle || "Empowering organizations to simplify employee experiences and automate complex Indian workforce management.";
    const displayDescription = description || "HR Niti is engineered to eliminate administrative bottlenecks, automate multi-state statutory compliance, and help HR teams focus on their most valuable asset – people.";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await submitDemoLeadAction({
            ...
            sourcePage: "About Us Hero",
            sourceUrl: typeof window !== "undefined" ? window.location.href : "https://www.hrniti.com/about",
        });
        ...
        if (res.success) {
            setSubmitted(true);
            setFormData({ name: "", email: "", phone: "", company: "", employees: "50-250" });
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-6 text-left">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-xs md:text-sm font-semibold border border-white/20 text-emerald-200">
                            ...
                            <span>AI-Powered HRMS &amp; Automated Payroll for India</span>
                        </div>
                        ...
                        <p className="text-sm md:text-base text-emerald-100/80 leading-relaxed max-w-2xl font-medium">
                            {displayDescription}
                        </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                            {[
                                "100% Multi-State Tax Engine (PF/ESIC/PT)",
                                "Bank-Ready Payout Excel Export",
                                "Niti AI Employee Self-Service",
                                "Guided 48-Hour Rapid Go-Live"
                            ].map((item, index) => (
                        ...
                        <div className="bg-emerald-900/50 border border-emerald-500/30 backdrop-blur-md rounded-xl p-4 text-left shadow-lg">
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-xs md:text-sm text-emerald-100 leading-relaxed font-medium">
                                    HR Niti is a leading Indian cloud HRMS platform designed to unify employee management, attendance tracking, multi-state payroll, and AI conversational self-service into one seamless operating system.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-6 pt-2 text-xs md:text-sm text-emerald-200 font-medium">
                            <div className="flex items-center gap-2">
                                ...
                                <span>Multi-State Legal Governance (&quot;Niti &amp; Niyam&quot;)</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                                <span>Enterprise Cloud Data Security</span>
                            </div>
                        </div>

                    </div>

                    {/* RIGHT COLUMN: UPPER FOLD LEAD FORM CARD */}
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 text-gray-900 border border-amber-200/50 relative overflow-hidden">
                            ...
                            <div className="mb-6 text-center lg:text-left">
                                ...
                                <h3 className="text-2xl font-extrabold text-gray-900 mt-2">
                                    Experience HR Niti Live
                                </h3>
                                <p className="text-xs text-gray-500 mt-1 font-medium">
                                    Book a free 1-on-1 personalized platform demonstration.
                                </p>
                            </div>
                            ...
                            {submitted ? (
                                <div className="p-6 bg-emerald-50 rounded-xl text-center border border-emerald-200">
                                    ...
                                    <p className="text-xs text-emerald-800 mt-1 font-medium">
                                        Our specialist will connect with you within 15 minutes.
                                    </p>
                                </div>
                            ) : (
